...
public class MovieList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButtonEdit.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jButtonEdit.setForeground(new java.awt.Color(0, 0, 0));
        jButtonEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/Edit-32.png"))); // NOI18N
        ...
        jPanel1.add(jButtonEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 410, 140, -1));

        jButtonDelete.setBackground(new java.awt.Color(153, 255, 153));
        jButtonDelete.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        jButtonDelete.setForeground(new java.awt.Color(0, 0, 0));
        jButtonDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons/Trash.32.png"))); // NOI18N
        ...
        jPanel1.add(jButtonDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 470, 140, -1));
        ...
        jPanel1.add(jButtonHome, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 490, 60, 60));
        ...
        jPanel1.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 820, 560));
    ...
    private void jButtonEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEditActionPerformed
        // TODO add your handling code here:
        EditMovie edit = new EditMovie(movieID_Display);
        this.setVisible(false);
        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        edit.pack();
    ...
    private void jButtonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDeleteActionPerformed
        ...
        int option = JOptionPane.showConfirmDialog(this, "Do you want to remove movie?", "WARNNING", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, icon);
        if(option == JOptionPane.YES_OPTION){
            boolean result = Remove(movieID_Display);
            if(result){
                icon = new ImageIcon(getClass().getResource("/resources/icons/Ok-48.png"));
                JOptionPane.showMessageDialog(this, "Remove successfully!"," SUCCESSFULL",JOptionPane.INFORMATION_MESSAGE,icon);
            }else{
                icon = new ImageIcon(getClass().getResource("/resources/icons/error-48.png"));
                JOptionPane.showMessageDialog(this, "Remove failed!"," FAILED",JOptionPane.INFORMATION_MESSAGE,icon);
            }
        }    
